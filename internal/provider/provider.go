...
func (p *AciProvider) Resources(_ context.Context) []func() resource.Resource {
	return providerResources()
}

func (p *AciProvider) DataSources(_ context.Context) []func() datasource.DataSource {
...
func (p *AciProvider) Functions(_ context.Context) []func() function.Function {
