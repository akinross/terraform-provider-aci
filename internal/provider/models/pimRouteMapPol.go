...
func (m *PimRouteMapPolModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *PimRouteMapPolResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"pimRouteMapPol": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
