...
func (m *VzRsAnyToConsModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *VzRsAnyToConsResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"vzRsAnyToCons": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
