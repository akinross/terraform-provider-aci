...
func (m *InfraRsAccBaseGrpModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func InfraRsAccBaseGrpModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *InfraRsAccBaseGrpModel,
) (InfraRsAccBaseGrpModel, diag.Diagnostics) {
	model := NewInfraRsAccBaseGrpModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "infraRsAccBaseGrp")
	if !ok {
		return model, diagnostics
	}
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "annotation", &model.Annotation)
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "fexId", &model.FexId)
...
func (m *InfraRsAccBaseGrpModel) BuildPayloadObject(
	ctx context.Context,
	priorState *InfraRsAccBaseGrpModel,
	nested bool,
	...
	modelHelpers.AddPayloadStringAttribute(ctx, &diagnostics, attributes, "fexId", m.FexId)
...
func (m *InfraRsAccBaseGrpModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
