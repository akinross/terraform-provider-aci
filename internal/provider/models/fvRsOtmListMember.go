...
func (m *FvRsOtmListMemberModel) BuildPayloadObject(
	...
	if !m.Weight.IsNull() && !m.Weight.IsUnknown() {
		attributes["weight"] = m.Weight.ValueString()
	}
...
func (m *FvRsOtmListMemberModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRsOtmListMemberResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRsOtmListMember": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
