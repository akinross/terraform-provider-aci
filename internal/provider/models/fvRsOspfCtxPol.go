...
func (m *FvRsOspfCtxPolModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvRsOspfCtxPolModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvRsOspfCtxPolModel,
) (FvRsOspfCtxPolModel, diag.Diagnostics) {
	model := NewFvRsOspfCtxPolModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvRsOspfCtxPol")
	if !ok {
...
func (m *FvRsOspfCtxPolModel) BuildPayloadObject(
	ctx context.Context,
	priorState *FvRsOspfCtxPolModel,
	nested bool,
