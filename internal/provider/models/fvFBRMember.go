...
func (m *FvFBRMemberModel) BuildPayloadObject(
	...
	if !m.RnhAddr.IsNull() && !m.RnhAddr.IsUnknown() {
...
func (m *FvFBRMemberModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvFBRMemberResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvFBRMember": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
