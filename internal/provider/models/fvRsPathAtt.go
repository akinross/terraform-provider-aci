...
func (m *FvRsPathAttModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRsPathAttResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRsPathAtt": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
