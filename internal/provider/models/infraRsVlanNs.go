...
func InfraRsVlanNsModelAttributeTypes() map[string]attr.Type {
...
func NewInfraRsVlanNsModelNull() InfraRsVlanNsModel {
	return InfraRsVlanNsModel{
...
func (m *InfraRsVlanNsModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func InfraRsVlanNsModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *InfraRsVlanNsModel,
) (InfraRsVlanNsModel, diag.Diagnostics) {
	model := NewInfraRsVlanNsModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "infraRsVlanNs")
	if !ok {
...
func (m *InfraRsVlanNsModel) BuildPayloadObject(
	ctx context.Context,
	priorState *InfraRsVlanNsModel,
	nested bool,
...
func (m *InfraRsVlanNsModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
