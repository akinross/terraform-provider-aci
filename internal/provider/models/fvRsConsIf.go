...
func (m *FvRsConsIfModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRsConsIfResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRsConsIf": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
