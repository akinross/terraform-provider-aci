...
func (m *VmmRsDomMcastAddrNsModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func VmmRsDomMcastAddrNsModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *VmmRsDomMcastAddrNsModel,
) (VmmRsDomMcastAddrNsModel, diag.Diagnostics) {
	model := NewVmmRsDomMcastAddrNsModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "vmmRsDomMcastAddrNs")
	if !ok {
...
func (m *VmmRsDomMcastAddrNsModel) BuildPayloadObject(
	ctx context.Context,
	priorState *VmmRsDomMcastAddrNsModel,
	nested bool,
...
func (m *VmmRsDomMcastAddrNsModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
