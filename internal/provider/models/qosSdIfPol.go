...
func (m *QosSdIfPolModel) BuildPayloadObject(
	...
	if !m.CongClearAction.IsNull() && !m.CongClearAction.IsUnknown() {
		attributes["congClearAction"] = m.CongClearAction.ValueString()
	}
	if !m.CongDetectMult.IsNull() && !m.CongDetectMult.IsUnknown() {
		attributes["congDetectMult"] = m.CongDetectMult.ValueString()
	}
	if !m.Descr.IsNull() && !m.Descr.IsUnknown() {
		attributes["descr"] = m.Descr.ValueString()
	}
	if !m.FlushAdminSt.IsNull() && !m.FlushAdminSt.IsUnknown() {
		attributes["flushAdminSt"] = m.FlushAdminSt.ValueString()
	}
	if !m.FlushIntvl.IsNull() && !m.FlushIntvl.IsUnknown() {
		attributes["flushIntvl"] = m.FlushIntvl.ValueString()
	}
...
func (m *QosSdIfPolModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *QosSdIfPolResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"qosSdIfPol": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
