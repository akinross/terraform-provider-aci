...
func (m *FabricLinkFlapPolModel) BuildPayloadObject(
	...
	if !m.LinkFlapErrorMax.IsNull() && !m.LinkFlapErrorMax.IsUnknown() {
		attributes["linkFlapErrorMax"] = m.LinkFlapErrorMax.ValueString()
	}
	if !m.LinkFlapErrorSeconds.IsNull() && !m.LinkFlapErrorSeconds.IsUnknown() {
		attributes["linkFlapErrorSeconds"] = m.LinkFlapErrorSeconds.ValueString()
	}
...
func (m *FabricLinkFlapPolModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FabricLinkFlapPolResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fabricLinkFlapPol": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
