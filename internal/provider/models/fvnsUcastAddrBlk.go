...
func (m *FvnsUcastAddrBlkModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvnsUcastAddrBlkResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvnsUcastAddrBlk": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
