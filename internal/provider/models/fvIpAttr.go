...
func (m *FvIpAttrModel) BuildPayloadObject(
	...
	if !m.UsefvSubnet.IsNull() && !m.UsefvSubnet.IsUnknown() {
		attributes["usefvSubnet"] = m.UsefvSubnet.ValueString()
	}
...
func (m *FvIpAttrModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvIpAttrResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvIpAttr": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
