...
func (m *L3extRsInstPToProfileModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *L3extRsInstPToProfileResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"l3extRsInstPToProfile": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
