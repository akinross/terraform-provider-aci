...
func (m *FvIdGroupAttrModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvIdGroupAttrResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvIdGroupAttr": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
