...
func (m *FvRsSecInheritedModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRsSecInheritedResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRsSecInherited": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
