...
func (m *QosDscpClassModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *QosDscpClassResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"qosDscpClass": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
