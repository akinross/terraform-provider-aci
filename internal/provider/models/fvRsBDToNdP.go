...
func (m *FvRsBDToNdPModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvRsBDToNdPModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvRsBDToNdPModel,
) (FvRsBDToNdPModel, diag.Diagnostics) {
	model := NewFvRsBDToNdPModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvRsBDToNdP")
	if !ok {
		return model, diagnostics
	}
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "annotation", &model.Annotation)
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "tnNdIfPolName", &model.TnNdIfPolName)
...
func (m *FvRsBDToNdPModel) BuildPayloadObject(
	...
	modelHelpers.AddPayloadStringAttribute(ctx, &diagnostics, attributes, "tnNdIfPolName", m.TnNdIfPolName)
