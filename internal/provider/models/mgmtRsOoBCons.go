...
func (m *MgmtRsOoBConsModel) BuildPayloadObject(
	...
	if !m.TnVzOOBBrCPName.IsNull() && !m.TnVzOOBBrCPName.IsUnknown() {
...
func (m *MgmtRsOoBConsModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *MgmtRsOoBConsResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"mgmtRsOoBCons": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
