...
func (m *PoeRsPoeEpgModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func PoeRsPoeEpgModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *PoeRsPoeEpgModel,
) (PoeRsPoeEpgModel, diag.Diagnostics) {
	model := NewPoeRsPoeEpgModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "poeRsPoeEpg")
	if !ok {
...
func (m *PoeRsPoeEpgModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
