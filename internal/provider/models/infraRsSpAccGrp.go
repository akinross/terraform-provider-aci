...
type InfraRsSpAccGrpModel struct {
...
func InfraRsSpAccGrpModelAttributeTypes() map[string]attr.Type {
...
func NewInfraRsSpAccGrpModelNull() InfraRsSpAccGrpModel {
	return InfraRsSpAccGrpModel{
...
func (m *InfraRsSpAccGrpModel) BuildDN(parentDN string) string {
	return parentDN + "/" + m.BuildRN()
}

func (m *InfraRsSpAccGrpModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func InfraRsSpAccGrpModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *InfraRsSpAccGrpModel,
) (InfraRsSpAccGrpModel, diag.Diagnostics) {
	model := NewInfraRsSpAccGrpModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "infraRsSpAccGrp")
	if !ok {
...
func (m *InfraRsSpAccGrpModel) BuildPayloadObject(
	ctx context.Context,
	priorState *InfraRsSpAccGrpModel,
	nested bool,
...
func (m *InfraRsSpAccGrpModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
