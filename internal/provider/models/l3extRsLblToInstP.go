...
func (m *L3extRsLblToInstPModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *L3extRsLblToInstPResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"l3extRsLblToInstP": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
