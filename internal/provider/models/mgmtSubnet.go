...
func (m *MgmtSubnetModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *MgmtSubnetResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"mgmtSubnet": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
