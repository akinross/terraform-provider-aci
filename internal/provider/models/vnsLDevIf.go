...
func (m *VnsLDevIfModel) BuildPayloadObject(
	...
	if !m.Description.IsNull() && !m.Description.IsUnknown() {
		attributes["description"] = m.Description.ValueString()
	}
	if !m.Ldev.IsNull() && !m.Ldev.IsUnknown() {
...
func (m *VnsLDevIfModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *VnsLDevIfResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"vnsLDevIf": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
