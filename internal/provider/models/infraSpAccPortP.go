...
func InfraSpAccPortPModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *InfraSpAccPortPModel,
) (InfraSpAccPortPModel, diag.Diagnostics) {
	model := NewInfraSpAccPortPModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "infraSpAccPortP")
	if !ok {
...
func InfraSpAccPortPModelFromResponse(
	ctx context.Context,
	response *container.Container,
	fallbackModel *InfraSpAccPortPModel,
) (*InfraSpAccPortPModel, string, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	model, dn := modelHelpers.ModelFromResponse(ctx, &diagnostics, response, "infraSpAccPortP", fallbackModel, InfraSpAccPortPModelFromObject)
	return model, dn, diagnostics
}

func (m *InfraSpAccPortPModel) BuildPayloadObject(
	ctx context.Context,
	priorState *InfraSpAccPortPModel,
	nested bool,
...
func (m *InfraSpAccPortPModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
...
func (m *InfraSpAccPortPResourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.InfraSpAccPortPModel
	model, dn, diagnostics := InfraSpAccPortPModelFromResponse(ctx, response, &fallbackModel)
	found := model != nil
	if diagnostics.HasError() || !found {
		return found, diagnostics
	}

	m.InfraSpAccPortPModel = *model
	m.ID = types.StringValue(dn)
	return true, diagnostics
}

func (m *InfraSpAccPortPResourceModel) BuildPayload(
	ctx context.Context,
	priorState *InfraSpAccPortPModel,
	create bool,
	markCreated bool,
	...
	payloadEnvelope := map[string]any{"infraSpAccPortP": payloadObject}
	jsonPayload := modelHelpers.NewPayloadContainer(ctx, &diagnostics, payloadEnvelope, "JSON payload")
	return jsonPayload, diagnostics
}

func (m *InfraSpAccPortPResourceModel) BuildDeletePayload(ctx context.Context) (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload := modelHelpers.NewDeletePayload(ctx, &diagnostics, "infraSpAccPortP", m.ID.ValueString())
...
func (m *InfraSpAccPortPDataSourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.InfraSpAccPortPModel
