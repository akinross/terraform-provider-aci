...
func (m *InfraSpAccPortPModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *InfraSpAccPortPResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"infraSpAccPortP": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
