...
func (m *FvRsIgmpsnModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvRsIgmpsnModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvRsIgmpsnModel,
) (FvRsIgmpsnModel, diag.Diagnostics) {
	model := NewFvRsIgmpsnModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvRsIgmpsn")
	if !ok {
		return model, diagnostics
	}
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "annotation", &model.Annotation)
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "tnIgmpSnoopPolName", &model.TnIgmpSnoopPolName)
...
func (m *FvRsIgmpsnModel) BuildPayloadObject(
	ctx context.Context,
	priorState *FvRsIgmpsnModel,
	nested bool,
	...
	modelHelpers.AddPayloadStringAttribute(ctx, &diagnostics, attributes, "tnIgmpSnoopPolName", m.TnIgmpSnoopPolName)
