...
func (m *QosLlfcIfPolModel) BuildPayloadObject(
	...
	if !m.LlfcRcvAdminSt.IsNull() && !m.LlfcRcvAdminSt.IsUnknown() {
		attributes["llfcRcvAdminSt"] = m.LlfcRcvAdminSt.ValueString()
	}
	if !m.LlfcSendAdminSt.IsNull() && !m.LlfcSendAdminSt.IsUnknown() {
		attributes["llfcSendAdminSt"] = m.LlfcSendAdminSt.ValueString()
	}
...
func (m *QosLlfcIfPolModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *QosLlfcIfPolResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"qosLlfcIfPol": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
