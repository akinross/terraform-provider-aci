...
func (m *FvRsCtxToExtRouteTagPolModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvRsCtxToExtRouteTagPolModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvRsCtxToExtRouteTagPolModel,
) (FvRsCtxToExtRouteTagPolModel, diag.Diagnostics) {
	model := NewFvRsCtxToExtRouteTagPolModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvRsCtxToExtRouteTagPol")
	if !ok {
		return model, diagnostics
	}
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "annotation", &model.Annotation)
	modelHelpers.DecodeStringAttribute(ctx, &diagnostics, attributes, "tnL3extRouteTagPolName", &model.TnL3extRouteTagPolName)
...
func (m *FvRsCtxToExtRouteTagPolModel) BuildPayloadObject(
	ctx context.Context,
	priorState *FvRsCtxToExtRouteTagPolModel,
	nested bool,
	...
	modelHelpers.AddPayloadStringAttribute(ctx, &diagnostics, attributes, "tnL3extRouteTagPolName", m.TnL3extRouteTagPolName)
