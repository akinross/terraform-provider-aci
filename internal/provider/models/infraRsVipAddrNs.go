...
func InfraRsVipAddrNsModelAttributeTypes() map[string]attr.Type {
...
func NewInfraRsVipAddrNsModelNull() InfraRsVipAddrNsModel {
	return InfraRsVipAddrNsModel{
...
func (m *InfraRsVipAddrNsModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func InfraRsVipAddrNsModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *InfraRsVipAddrNsModel,
) (InfraRsVipAddrNsModel, diag.Diagnostics) {
	model := NewInfraRsVipAddrNsModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "infraRsVipAddrNs")
	if !ok {
...
func (m *InfraRsVipAddrNsModel) BuildPayloadObject(
	ctx context.Context,
	priorState *InfraRsVipAddrNsModel,
	nested bool,
...
func (m *InfraRsVipAddrNsModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
