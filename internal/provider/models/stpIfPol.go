...
func StpIfPolModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *StpIfPolModel,
) (StpIfPolModel, diag.Diagnostics) {
	model := NewStpIfPolModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "stpIfPol")
	if !ok {
...
func StpIfPolModelFromResponse(
	ctx context.Context,
	response *container.Container,
	fallbackModel *StpIfPolModel,
) (*StpIfPolModel, string, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	model, dn := modelHelpers.ModelFromResponse(ctx, &diagnostics, response, "stpIfPol", fallbackModel, StpIfPolModelFromObject)
	return model, dn, diagnostics
}

func (m *StpIfPolModel) BuildPayloadObject(
	ctx context.Context,
	priorState *StpIfPolModel,
	nested bool,
...
func (m *StpIfPolModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
...
func (m *StpIfPolResourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.StpIfPolModel
	model, dn, diagnostics := StpIfPolModelFromResponse(ctx, response, &fallbackModel)
	found := model != nil
	if diagnostics.HasError() || !found {
		return found, diagnostics
	}

	m.StpIfPolModel = *model
	m.ID = types.StringValue(dn)
	return true, diagnostics
}

func (m *StpIfPolResourceModel) BuildPayload(
	ctx context.Context,
	priorState *StpIfPolModel,
	create bool,
	markCreated bool,
	...
	payloadEnvelope := map[string]any{"stpIfPol": payloadObject}
	jsonPayload := modelHelpers.NewPayloadContainer(ctx, &diagnostics, payloadEnvelope, "JSON payload")
	return jsonPayload, diagnostics
}

func (m *StpIfPolResourceModel) BuildDeletePayload(ctx context.Context) (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload := modelHelpers.NewDeletePayload(ctx, &diagnostics, "stpIfPol", m.ID.ValueString())
...
func (m *StpIfPolDataSourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.StpIfPolModel
