...
func (m *FvRemoteIdModel) BuildPayloadObject(
	...
	if !m.RemoteCtxPcTag.IsNull() && !m.RemoteCtxPcTag.IsUnknown() {
		attributes["remoteCtxPcTag"] = m.RemoteCtxPcTag.ValueString()
	}
	if !m.RemotePcTag.IsNull() && !m.RemotePcTag.IsUnknown() {
		attributes["remotePcTag"] = m.RemotePcTag.ValueString()
	}
...
func (m *FvRemoteIdModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRemoteIdResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRemoteId": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
