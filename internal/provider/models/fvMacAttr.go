...
func (m *FvMacAttrModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvMacAttrResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvMacAttr": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
