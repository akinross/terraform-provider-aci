...
func FvRsCtxToSDWanVpnModelAttributeTypes() map[string]attr.Type {
...
func NewFvRsCtxToSDWanVpnModelNull() FvRsCtxToSDWanVpnModel {
	return FvRsCtxToSDWanVpnModel{
...
func (m *FvRsCtxToSDWanVpnModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvRsCtxToSDWanVpnModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvRsCtxToSDWanVpnModel,
) (FvRsCtxToSDWanVpnModel, diag.Diagnostics) {
	model := NewFvRsCtxToSDWanVpnModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvRsCtxToSDWanVpn")
	if !ok {
...
func (m *FvRsCtxToSDWanVpnModel) BuildPayloadObject(
	ctx context.Context,
	priorState *FvRsCtxToSDWanVpnModel,
	nested bool,
...
func (m *FvRsCtxToSDWanVpnModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
