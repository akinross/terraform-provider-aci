...
func (m *FvSiteAssociatedModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvSiteAssociatedModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvSiteAssociatedModel,
) (FvSiteAssociatedModel, diag.Diagnostics) {
	model := NewFvSiteAssociatedModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvSiteAssociated")
	if !ok {
	...
	modelHelpers.DecodeRepeatedChildren(
		ctx,
		&diagnostics,
		childObjects["fvRemoteId"],
		FvRemoteIdModelAttributeTypes(),
		FvRemoteIdModelFromObject,
		&model.FvRemoteId,
	)
	modelHelpers.DecodeRepeatedChildren(
		ctx,
...
func FvSiteAssociatedModelFromResponse(
	ctx context.Context,
	response *container.Container,
	fallbackModel *FvSiteAssociatedModel,
) (*FvSiteAssociatedModel, string, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	model, dn := modelHelpers.ModelFromResponse(ctx, &diagnostics, response, "fvSiteAssociated", fallbackModel, FvSiteAssociatedModelFromObject)
	return model, dn, diagnostics
}

func (m *FvSiteAssociatedModel) BuildPayloadObject(
	ctx context.Context,
	priorState *FvSiteAssociatedModel,
	nested bool,
	...
	var priorFvRemoteId *types.Set
	if priorState != nil {
		priorFvRemoteId = &priorState.FvRemoteId
	}
	fvRemoteIdPayloads, ok := modelHelpers.BuildRepeatedChildPayloads(
		ctx,
		&diagnostics,
		m.FvRemoteId,
		priorFvRemoteId,
		"fvRemoteId",
		"FvRemoteId object defined by remote_sites cannot be deleted",
		defaultAnnotation,
		(*FvRemoteIdModel).BuildRN,
		(*FvRemoteIdModel).BuildPayloadObject,
		(*FvRemoteIdModel).BuildNestedDeletePayloadObject,
	)
	if !ok {
		return nil, diagnostics
	}
	children = append(children, fvRemoteIdPayloads...)
...
func (m *FvSiteAssociatedModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
...
func (m *FvSiteAssociatedResourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.FvSiteAssociatedModel
	model, dn, diagnostics := FvSiteAssociatedModelFromResponse(ctx, response, &fallbackModel)
	found := model != nil
	if diagnostics.HasError() || !found {
		return found, diagnostics
	}

	m.FvSiteAssociatedModel = *model
	m.ID = types.StringValue(dn)
	m.ParentDn = types.StringValue(model.ParentDNFromDN(dn))
	return true, diagnostics
}

func (m *FvSiteAssociatedResourceModel) BuildPayload(
	ctx context.Context,
	priorState *FvSiteAssociatedModel,
	create bool,
	markCreated bool,
	...
	payloadEnvelope := map[string]any{"fvSiteAssociated": payloadObject}
	jsonPayload := modelHelpers.NewPayloadContainer(ctx, &diagnostics, payloadEnvelope, "JSON payload")
	return jsonPayload, diagnostics
}

func (m *FvSiteAssociatedResourceModel) BuildDeletePayload(ctx context.Context) (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload := modelHelpers.NewDeletePayload(ctx, &diagnostics, "fvSiteAssociated", m.ID.ValueString())
...
func (m *FvSiteAssociatedDataSourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.FvSiteAssociatedModel
