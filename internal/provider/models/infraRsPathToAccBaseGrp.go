...
type InfraRsPathToAccBaseGrpModel struct {
...
func InfraRsPathToAccBaseGrpModelAttributeTypes() map[string]attr.Type {
...
func NewInfraRsPathToAccBaseGrpModelNull() InfraRsPathToAccBaseGrpModel {
	return InfraRsPathToAccBaseGrpModel{
...
func (m *InfraRsPathToAccBaseGrpModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func InfraRsPathToAccBaseGrpModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *InfraRsPathToAccBaseGrpModel,
) (InfraRsPathToAccBaseGrpModel, diag.Diagnostics) {
	model := NewInfraRsPathToAccBaseGrpModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "infraRsPathToAccBaseGrp")
	if !ok {
...
func (m *InfraRsPathToAccBaseGrpModel) BuildPayloadObject(
	ctx context.Context,
	priorState *InfraRsPathToAccBaseGrpModel,
	nested bool,
...
func (m *InfraRsPathToAccBaseGrpModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
