...
func (m *FvRsFcPathAttModel) BuildPayloadObject(
	...
	if !m.Vsan.IsNull() && !m.Vsan.IsUnknown() {
		attributes["vsan"] = m.Vsan.ValueString()
	}
	if !m.VsanMode.IsNull() && !m.VsanMode.IsUnknown() {
		attributes["vsanMode"] = m.VsanMode.ValueString()
	}
...
func (m *FvRsFcPathAttModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRsFcPathAttResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRsFcPathAtt": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
