...
func (m *FvRsIntraEpgModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRsIntraEpgResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRsIntraEpg": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
