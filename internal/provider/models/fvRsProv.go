...
func (m *FvRsProvModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvRsProvModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvRsProvModel,
) (FvRsProvModel, diag.Diagnostics) {
	model := NewFvRsProvModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvRsProv")
	if !ok {
	...
	modelHelpers.DecodeCustomStringAttribute(ctx, &diagnostics, attributes, "prio", &model.Prio, customTypes.NewFvRsProvPrioStringValue)
...
func FvRsProvModelFromResponse(
	ctx context.Context,
	response *container.Container,
	fallbackModel *FvRsProvModel,
) (*FvRsProvModel, string, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	model, dn := modelHelpers.ModelFromResponse(ctx, &diagnostics, response, "fvRsProv", fallbackModel, FvRsProvModelFromObject)
...
func (m *FvRsProvModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
...
func (m *FvRsProvResourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.FvRsProvModel
	model, dn, diagnostics := FvRsProvModelFromResponse(ctx, response, &fallbackModel)
	found := model != nil
	if diagnostics.HasError() || !found {
		return found, diagnostics
	}

	m.FvRsProvModel = *model
	m.ID = types.StringValue(dn)
...
func (m *FvRsProvResourceModel) BuildDeletePayload(ctx context.Context) (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload := modelHelpers.NewDeletePayload(ctx, &diagnostics, "fvRsProv", m.ID.ValueString())
...
func (m *FvRsProvDataSourceModel) SetFromResponse(
	ctx context.Context,
	response *container.Container,
) (bool, diag.Diagnostics) {
	fallbackModel := m.FvRsProvModel
