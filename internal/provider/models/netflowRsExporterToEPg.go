...
func (m *NetflowRsExporterToEPgModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func NetflowRsExporterToEPgModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *NetflowRsExporterToEPgModel,
) (NetflowRsExporterToEPgModel, diag.Diagnostics) {
	model := NewNetflowRsExporterToEPgModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "netflowRsExporterToEPg")
	if !ok {
...
func (m *NetflowRsExporterToEPgModel) BuildPayloadObject(
	ctx context.Context,
	priorState *NetflowRsExporterToEPgModel,
	nested bool,
...
func (m *NetflowRsExporterToEPgModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
