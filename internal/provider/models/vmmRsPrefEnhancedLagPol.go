...
type VmmRsPrefEnhancedLagPolModel struct {
...
func VmmRsPrefEnhancedLagPolModelAttributeTypes() map[string]attr.Type {
...
func NewVmmRsPrefEnhancedLagPolModelNull() VmmRsPrefEnhancedLagPolModel {
	return VmmRsPrefEnhancedLagPolModel{
...
func (m *VmmRsPrefEnhancedLagPolModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func VmmRsPrefEnhancedLagPolModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *VmmRsPrefEnhancedLagPolModel,
) (VmmRsPrefEnhancedLagPolModel, diag.Diagnostics) {
	model := NewVmmRsPrefEnhancedLagPolModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "vmmRsPrefEnhancedLagPol")
	if !ok {
...
func (m *VmmRsPrefEnhancedLagPolModel) BuildPayloadObject(
	ctx context.Context,
	priorState *VmmRsPrefEnhancedLagPolModel,
	nested bool,
...
func (m *VmmRsPrefEnhancedLagPolModel) BuildNestedDeletePayloadObject(
	ctx context.Context,
