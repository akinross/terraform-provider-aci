...
func (m *FvRsBDToFhsModel) BuildPayloadObject(
	...
	if !m.TnFhsBDPolName.IsNull() && !m.TnFhsBDPolName.IsUnknown() {
		attributes["tnFhsBDPolName"] = m.TnFhsBDPolName.ValueString()
	}
...
func (m *FvRsBDToFhsModel) BuildNestedDeletePayloadObject() map[string]any {
