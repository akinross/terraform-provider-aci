...
func (m *FvCrtrnModel) BuildPayloadObject(
	...
	if !m.Match.IsNull() && !m.Match.IsUnknown() {
		attributes["match"] = m.Match.ValueString()
	}
	...
	if !m.Prec.IsNull() && !m.Prec.IsUnknown() {
		attributes["prec"] = m.Prec.ValueString()
	}
...
func (m *FvCrtrnModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvCrtrnResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvCrtrn": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
