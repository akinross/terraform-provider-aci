...
func (m *LldpIfPolModel) BuildPayloadObject(
	...
	if !m.AdminRxSt.IsNull() && !m.AdminRxSt.IsUnknown() {
		attributes["adminRxSt"] = m.AdminRxSt.ValueString()
	}
	if !m.AdminTxSt.IsNull() && !m.AdminTxSt.IsUnknown() {
		attributes["adminTxSt"] = m.AdminTxSt.ValueString()
	}
	...
	if !m.PortDCBXPVer.IsNull() && !m.PortDCBXPVer.IsUnknown() {
		attributes["portDCBXPVer"] = m.PortDCBXPVer.ValueString()
	}
...
func (m *LldpIfPolModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *LldpIfPolResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"lldpIfPol": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
