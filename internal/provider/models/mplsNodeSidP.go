...
func (m *MplsNodeSidPModel) BuildPayloadObject(
	...
	if !m.LoopbackAddr.IsNull() && !m.LoopbackAddr.IsUnknown() {
		attributes["loopbackAddr"] = m.LoopbackAddr.ValueString()
	}
	...
	if !m.Sidoffset.IsNull() && !m.Sidoffset.IsUnknown() {
...
func (m *MplsNodeSidPModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *MplsNodeSidPResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"mplsNodeSidP": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
