...
func (m *DwdmIfPolModel) BuildPayloadObject(
	...
	if !m.FcotChannelNumber.IsNull() && !m.FcotChannelNumber.IsUnknown() {
		attributes["fcotChannelNumber"] = m.FcotChannelNumber.ValueString()
	}
...
func (m *DwdmIfPolModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *DwdmIfPolResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"dwdmIfPol": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
