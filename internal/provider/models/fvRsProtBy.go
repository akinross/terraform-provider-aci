...
func (m *FvRsProtByModel) BuildPayloadObject(
	...
	if !m.TnVzTabooName.IsNull() && !m.TnVzTabooName.IsUnknown() {
...
func (m *FvRsProtByModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *FvRsProtByResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"fvRsProtBy": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
