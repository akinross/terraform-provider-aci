...
func (m *L3extRsOutToFBRGroupModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *L3extRsOutToFBRGroupResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"l3extRsOutToFBRGroup": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
