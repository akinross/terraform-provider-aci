...
func (m *FvRsCtxToEpRetModel) ParentDNFromDN(dn string) string {
	rn := m.BuildRN()
...
func FvRsCtxToEpRetModelFromObject(
	ctx context.Context,
	object *container.Container,
	fallbackModel *FvRsCtxToEpRetModel,
) (FvRsCtxToEpRetModel, diag.Diagnostics) {
	model := NewFvRsCtxToEpRetModelNull()
	var diagnostics diag.Diagnostics

	attributes, ok := modelHelpers.AttributesFromObject(ctx, &diagnostics, object, "fvRsCtxToEpRet")
	if !ok {
...
func (m *FvRsCtxToEpRetModel) BuildPayloadObject(
	ctx context.Context,
	priorState *FvRsCtxToEpRetModel,
	nested bool,
