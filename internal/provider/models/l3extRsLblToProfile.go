...
func (m *L3extRsLblToProfileModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *L3extRsLblToProfileResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"l3extRsLblToProfile": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
