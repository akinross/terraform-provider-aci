...
func (m *VmmUsrAccPModel) BuildPayloadObject(
	...
	if !m.Pwd.IsNull() && !m.Pwd.IsUnknown() {
		attributes["pwd"] = m.Pwd.ValueString()
	}
	if !m.Usr.IsNull() && !m.Usr.IsUnknown() {
		attributes["usr"] = m.Usr.ValueString()
	}
...
func (m *VmmUsrAccPModel) BuildNestedDeletePayloadObject() map[string]any {
...
func (m *VmmUsrAccPResourceModel) BuildDeletePayload() (*container.Container, diag.Diagnostics) {
	var diagnostics diag.Diagnostics
	payload, err := json.Marshal(map[string]any{
		"vmmUsrAccP": map[string]any{
			"attributes": map[string]any{
				"dn":     m.ID.ValueString(),
				"status": "deleted",
			},
